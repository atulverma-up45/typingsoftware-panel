      ...
      <header className="flex h-[72px] shrink-0 items-center justify-between px-4 sm:px-6 bg-white border-b border-gray-100 relative z-30">
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button
            ...
            className="hidden sm:flex items-center justify-between h-[42px] w-64 md:w-80 rounded-2xl border border-gray-200/90 bg-gray-50/50 hover:bg-white pl-3.5 pr-2.5 text-xs text-gray-400 hover:border-[#ff8a5c]/50 transition-all shadow-2xs group cursor-pointer text-left"
          >
            <div className="flex items-center gap-2.5">
              <Search size={16} className="text-gray-400 group-hover:text-[#ff8a5c] transition-colors" />
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          >
            <Bell size={20} />
            <span className="absolute top-2 right-2 h-2 w-2 rounded-full bg-[#ff8a5c] ring-2 ring-white"></span>
          </button>
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="hidden sm:flex items-center gap-2 rounded-full border border-gray-100 bg-gray-50/80 py-1.5 px-3 max-w-[200px]">
                <Building2 size={15} className="text-[#ff8a5c] shrink-0" />
              ...
              <div className="flex h-9 w-9 sm:h-[38px] sm:w-[38px] items-center justify-center rounded-full bg-[#fff0eb] text-[#ff8a5c] font-bold text-xs border border-[#ffe0d1] shadow-2xs">
                {userInitials}
              </div>
            </button>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2.5 w-60 rounded-2xl bg-white p-2 shadow-xl border border-gray-100 animate-in fade-in zoom-in-95 duration-150 z-50">
                <div className="px-3.5 py-2.5 border-b border-gray-100 mb-1.5">
                  ...
                  <span className="inline-block mt-1.5 px-2 py-0.2 rounded-full text-[10px] font-bold bg-orange-50 text-[#ff8a5c] border border-orange-200">
                    {user?.role || 'ADMIN'}
                  </span>
                </div>
